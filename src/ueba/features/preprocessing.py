...
# Layer A
# -------------------------------------------------------------
# Constants live in ueba.constants (re-exported here for backward
# compatibility — notebooks reference e.g. Preprocessing.WORK_HOURS).
from ueba.constants import (  # noqa: F401
...
def extract_http_features_chunked(
    ...
    combined = combine_partial_aggregations(partial_aggs, MERGE_COLS)
    print("  Building unique count domains...")
