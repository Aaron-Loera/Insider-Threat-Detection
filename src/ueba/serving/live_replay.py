...
HF_FILENAME    = f"alert_table_{config.MODEL_VERSION}.parquet"

# Local copy: use the alert table already generated by Alert_Object_Builder.ipynb.
_LOCAL_MERGED = config.ANALYST_TABLE_PARQUET
...
def _load_records() -> list[dict]:
    ...
    if os.path.exists(_LOCAL_MERGED):
        ...
        try:
            cached = get_dataset_file(HF_FILENAME, local_path=_LOCAL_MERGED)
